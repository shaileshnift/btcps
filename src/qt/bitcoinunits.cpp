...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTCS: return QString("Bitcoins");
    case mBTCS: return QString("Milli-Bitcoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTCS: return QString("Micro-Bitcoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
