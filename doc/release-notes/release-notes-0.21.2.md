...
Bitcoin Core version 0.21.2 is now available.
...
-----------------------
- The Proof of Stake(PoS) consensus has been merged into v0.20.2. All blocks from
  genesis to #301447 are BTC blocks via Proof of Work(PoW). Blocks #301448 and 
  onward have been mined using real BTC keys via Proof of Stake(PoS).
